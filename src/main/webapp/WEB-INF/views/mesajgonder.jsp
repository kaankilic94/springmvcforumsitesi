...
<html lang="en">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-4">
					...
					<div style="font-size: 80%; color: black" id="mesajgonderDiv">
              	<p style=" border-radius: 5px; background-color: #ffefef;"><c:out value="${mesajgonder}"></c:out></p>
              </div>
          
           <form action='<s:url value="/mesajgonder"></s:url>' method=post>
           
          <label for="kime">Kime:</label>
          <input type="text" class="form-control" id="kime" name="kime">
            
          <label for="baslik">Başlık:</label>
          <input type="text" class="form-control" id="baslik" name="baslik">
          
          <label for="comment">Mesaj Içeriği:</label><br>
          <textarea name="icerik" class="ckeditor" rows="5" id="comment"></textarea><br/>
 ...
 <script>
    setTimeout(function() {  
    	$('#mesajgonderDiv').delay(3000).hide('slow');  
	});
