    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!-- Blog Post -->
          <c:if test="${not empty araliste }">
          <c:forEach items="${araliste}" var="item">
          
          <div class="card mb-4">
            
            <div class="card-body">
              <h2><c:out value="${item.getKbaslik() }"></c:out></h2>
			   <p>Kategori: <a href='<s:url value="/kategori/${item.getKkategoriId() }"></s:url>'><c:out value="${item.getKkategori()}"></c:out></a> Yazar: <a href='<s:url value="/profil/${item.getKid()}"></s:url>'> <c:out value="${item.getKekleyen()}"></c:out></a>
